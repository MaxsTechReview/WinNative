...
void QrAuthSession::step_begin() {
    ...
    req.platform_type        = pb::EAuthTokenPlatformType::MobileApp;
    req.device_details.device_friendly_name = config_.device_friendly_name;
    req.device_details.platform_type        = pb::EAuthTokenPlatformType::MobileApp;
    req.device_details.os_type              = 528;
