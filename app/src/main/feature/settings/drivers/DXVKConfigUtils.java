...
public final class DXVKConfigUtils {
  ...
  public static final String[] VKD3D_FEATURE_LEVEL = {
    "12_0", "12_1", "12_2", "11_1", "11_0", "10_1", "10_0", "9_3", "9_2", "9_1"
  };
  ...
  public static KeyValueSet parseConfig(Object config) {
    String data =
        config != null && !config.toString().isEmpty() ? config.toString() : DEFAULT_CONFIG;
  ...
  public static void setEnvVars(
      Context context, KeyValueSet config, EnvVars envVars, int refreshRateOverride) {
    String content = "";
