...
internal val RETRO_CREDITS =
    listOf(
        ...
        RetroCredit("Eden Emulator Project", "Frame generation Vulkan chain", "GPL-3.0", "https://git.eden-emu.dev/eden-emu/eden"),
        ...
        RetroCredit("lsfg-vk", "Frame generation, upstream of Eden's port", "GPL-3.0", "https://github.com/PancakeTAS/lsfg-vk"),
