...
public class Container {
  public static final String DEFAULT_ENV_VARS =
      "WRAPPER_MAX_IMAGE_COUNT=0 VKD3D_SHADER_MODEL=6_6 ZINK_DESCRIPTORS=lazy ZINK_DEBUG=compact MESA_SHADER_CACHE_DISABLE=false MESA_SHADER_CACHE_MAX_SIZE=512MB mesa_glthread=true WINEESYNC=1 TU_DEBUG=noconform,sysmem";
  ...
  public static final String DEFAULT_DXWRAPPERCONFIG =
      "version="
          + DefaultVersion.DXVK
  ...
  public static final String FALLBACK_WINCOMPONENTS =
      "direct3d=1,directsound=1,directmusic=1,directshow=1,directplay=1,xaudio=1,vcrun2010=1";
    ...
    return () ->
        new Iterator<String[]>() {
          ...
          public String[] next() {
            ...
            item[1] =
                drives.substring(index[0] + 1, nextIndex != -1 ? nextIndex - 1 : drives.length());
            index[0] = nextIndex;
            return item;
          }
        };
