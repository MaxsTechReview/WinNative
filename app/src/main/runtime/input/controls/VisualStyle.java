 ...
 * held. ORIGINAL preserves the historic look (translucent white strokes, lightly filled when
 * engaged) and is listed last.
 *
...
public enum VisualStyle {
  ...
  public static String[] displayNames() {
    return new String[] {"Slate", "Glass", "Halo", "Glint", "Original"};
  }
}
